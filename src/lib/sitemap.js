...
export async function generateSitemap() {
  const baseUrl = "https://www.shopforrentingurgaon.com";
 ...
 //properties URLs
  ...
  try {
    const res = await axios.get(
      `https://deal-acres-backend.onrender.com/api/listed-properties/getPropertiesSlugs/www.shopforrentingurgaon.com`
    );
