...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav className="sticky top-0 z-50 bg-gradient-to-r from-[#FFBBE1] to-[#DD7BDF] shadow-md px-4 sm:px-6">
...
transition duration-300 shadow-md"
      ...
      {isOpen && (
        ...
        <div className="fixed top-[70px] left-0 w-full z-40 md:hidden bg-gradient-to-b from-[#FFBBE1] to-[#DD7BDF] shadow-xl">
