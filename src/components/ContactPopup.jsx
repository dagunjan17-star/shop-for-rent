  ...
  return (
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 px-4">
      ...
      <div className="bg-white w-full max-w-md rounded-2xl p-8 shadow-2xl relative border border-gray-100">
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-gray-400 hover:text-[#DD7BDF] text-xl transition"
        >
          ×
        </button>
        ...
        <p className="text-sm text-gray-600 mt-3 mb-7 leading-relaxed">
          ...
          <span className="block font-medium text-[#DD7BDF] mt-1">
            {propertyTitle}
          </span>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <textarea
            ...
            bg-white text-gray-900 placeholder-gray-400
            focus:ring-2 focus:ring-[#DD7BDF] focus:border-[#DD7BDF]
            outline-none resize-none transition text-2xl "
          />
