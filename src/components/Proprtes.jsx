                ...
                <div className="bg-white rounded shadow-md hover:shadow-2xl transition duration-300 overflow-hidden border border-gray-100 md:h-[280px]">
                  <div className="flex flex-col md:flex-row h-full">
                    ...
                    <button
                      ...
                      className="border border-[#DD7BDF] text-[#DD7BDF] px-5 py-2 rounded-lg hover:bg-[#FFF5FB] transition w-full md:w-auto font-medium"
                    >
                      Price on Call
                    </button>
                       <ViewDetailsButton className="bg-gradient-to-r from-[#FFBBE1] to-[#DD7BDF] text-white px-6 py-2 rounded-lg hover:opacity-90 transition w-full md:w-auto text-center font-medium"
