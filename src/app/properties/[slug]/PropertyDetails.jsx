...
export default function PropertyDetails({ propertyy }) {
  ...
  return (
    ...
    <div className="bg-gradient-to-b from-white to-[#FFF5FB] text-gray-900 px-4 sm:px-6 py-14">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[420px_1fr] gap-14 items-start">
          ...
          <div className="relative w-full h-[340px] rounded-2xl overflow-hidden shadow-xl border border-gray-100">
            ...
            {propertyy?.media?.url ? (
              ...
              <div className="flex items-center justify-center w-full h-full bg-[#FFF5FB] text-[#DD7BDF]">
                No Image Available
              </div>
          ...
          <div className="flex flex-col justify-between h-full">
            ...
            <div>
              ...
              {/* <p className="mt-6 text-3xl font-bold text-[#DD7BDF]">
                {propertyy?.price === 0
                  ? "Price on Request"
              ...
              <div className="mt-8 grid grid-cols-2 md:grid-cols-3 gap-y-6 gap-x-10 text-sm border-t border-[#FFBBE1] pt-6">
            ...
            <div className="mt-10">
              ...
              <button
                ...
                className="bg-gradient-to-r from-[#FFBBE1] to-[#DD7BDF]
                hover:opacity-90
        ...
        <section className="mt-20 border-t border-[#FFBBE1] pt-10">
