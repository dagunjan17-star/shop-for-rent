...
export default function FilterProperties({ area }) {
  ...
  if (loading2) {
    return (
      <section className="bg-[#FFF5FB] min-h-[60vh] flex items-center justify-center">

        <div className="text-center">

          <div className="w-12 h-12 border-4 border-[#DD7BDF] border-t-transparent rounded-full animate-spin mx-auto"></div>
  ...
  if (error2) {
    return (
      <section className="bg-[#FFF5FB] py-16">
        ...
        <div className="max-w-2xl mx-auto text-center bg-white p-8 rounded-2xl shadow-lg border border-red-100">
          ...
          <button
            ...
            className="mt-6 bg-[#DD7BDF] text-white px-6 py-2 rounded-lg hover:opacity-90 transition"
          >
            Retry
          </button>
  ...
  if (finalData.length === 0) {
    return (
      <section className="bg-[#FFF5FB] py-16 text-center">
  ...
  return (
    <section className="bg-gradient-to-b from-white to-[#FFF5FB] py-6 scroll-mt-24">
              ...
              <div className="p-4 flex-1 flex flex-col">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mt-6 relative">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-sm text-gray-500">
                      STATUS : <span className="font-semibold text-[#DD7BDF]">Available</span>
                    </p>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      TYPE : <span className="font-semibold text-gray-800">{property.propertyCategory}</span>
                    </p>
                ...
                <p className="text-sm text-gray-500 mt-4 line-clamp-2">
                  ...
                  {property.description ||
                    "Premium commercial property offering strong rental potential and excellent business visibility."}
                ...
                <div className="flex gap-3 border-t mt-6 pt-4">
  ...
  <button
    ...
    className="flex-1 border border-[#DD7BDF] text-[#DD7BDF] px-4 py-2 rounded-lg hover:bg-[#FFF5FB] transition text-sm font-medium text-center"
  >
    Price on Call
  </button>
