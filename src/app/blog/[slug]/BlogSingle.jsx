...
export default function BlogDetails({ post }) {
  ...
  return (
    ...
    bg-gradient-to-b from-white to-[#FFF5FB] py-10">
              ...
              {section?.img?.url && (
                <div className="w-full my-6">
                  <Image
                    ...
                    shadow-sm border border-[#DD7BDF]/10"
                  />
                </div>
              )}
            ...
            <div className="mt-14">
              ...
              <div className="space-y-4 max-w-6xl mx-auto">
                ...
                {single.FAQs.map((faq, i) => (
                  <details
                    key={i}
                    className="group bg-white border border-[#DD7BDF]/10 rounded-xl p-4 
                    shadow-sm hover:shadow-md transition duration-300"
                  >

                    <summary className="flex justify-between items-center cursor-pointer list-none">

                      <span className="font-semibold text-gray-900 group-hover:text-[#DD7BDF] transition">
                        {faq.Q}
                      </span>

                      <span className="ml-4 text-[#DD7BDF] transition-transform duration-300 group-open:rotate-180">
                        ▼
                      </span>
                    </summary>

                    <div className="mt-3 text-gray-600 leading-relaxed border-t border-[#DD7BDF]/10 pt-3">
                      {faq.A}
                    </div>
